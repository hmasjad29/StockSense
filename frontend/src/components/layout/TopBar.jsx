...
export default function TopBar({ symbol, setSymbol, lastUpdated, onRefresh }) {
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <div className="relative">
          ...
          >
            <option className="bg-slate-900" value="AAPL">
              AAPL
            </option>
            <option className="bg-slate-900" value="TSLA">
              TSLA
            </option>
            <option className="bg-slate-900" value="MSFT">
              MSFT
            </option>
          </select>
        ...
        <div className="text-xs text-white/60">Last updated: {lastUpdated}</div>
      </div>
    </div>
  );
}
